...
const NEGATE =[
    'dificilmente', 'nao', 'nao consegue', 'nao conseguem', 'nao conseguiam', 'nao conseguirei',
    'nao conseguiriam', 'nao consigo', 'nao devem', 'nao deverao', 'nao deveriam', 'nao devo',
    'nao e', 'nao eh', 'nao eram', 'nao estao', 'nao estarao', 'nao estariam', 'nao estavam',
    'nao estiveram', 'nao farao', 'nao farei', 'nao faz', 'nao faziam', 'nao fez', 'nao fiz',
    'nao ousa', 'nao ousam', 'nao ousarao', 'nao ousariam', 'nao ouso', 'nao poderei', 'nao poderia',
    'nao podia', 'nao posso', 'nao sao', 'nao serao', 'nao serei', 'nao seriam', 'nao sou',
    'nao tem', 'nao tenho', 'nao terei', 'nao teria', 'nao tinha', 'nope', 'raramente'
];
