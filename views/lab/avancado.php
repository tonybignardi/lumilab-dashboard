    ...
    foreach($layouts as $ll =>$cc)
    {
        ...
        <div class="<?php echo $ll;?>">
            <?php
                ...
                <?php 
                if($yy==1 && isset($indicador_posicao[$yy.$xx])) echo '<div>';?>
               
                <?php echo $debug?$yy.$xx:'';?>
                    <?php echo @$indicador_posicao[$yy.$xx];
                    ?>
                    </div>
                    ...
                    <?php 
                        if(@$opcoes[$yy.$xx][0])
                        {?>
                        <div id="botoes-<?php echo $opcoes[$yy.$xx][0]?>" style="display:<?php echo isset($indicador_posicao[$yy.$xx])?'inline':'none'?>">
